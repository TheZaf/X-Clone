...
/**
 * CustomIcon component renders the provided SVG path as a reusable icon.
 *
 * @param {object} props - Component props.
 * @param {number} [props.size=24] - The width and height of the icon in pixels.
 * @param {string} [props.color='#FFFFFF'] - The fill color of the icon.
 * @param {object} [props.props] - Any other standard SVG/React props (e.g., className, onClick).
 */
const CustomIcon = ({ size = 24, color = '#FFFFFF', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    // Setting a viewBox is crucial for the path to scale correctly.
    viewBox="0 0 32 32"
    width={size}
    height={size}
    fill={color}
    // Pass remaining props like className, aria-label, etc., to the SVG element
    {...props}
  >
    {/* The SVG path provided by the user */}
    <path 
